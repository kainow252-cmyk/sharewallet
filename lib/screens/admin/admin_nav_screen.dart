...
import 'admin_withdrawal_config_screen.dart';
...
class _AdminNavScreenState extends State<AdminNavScreen> {
  ...
  static const List<_NavItem> _items = [
    ...
    _NavItem(icon: Icons.price_change_rounded,             label: 'Limites Saque'),
  ...
  late final List<Widget> _screens = [
    ...
    const AdminWithdrawalConfigScreen(),
  ...
  void _refresh() {
    ...
    switch (_selectedIndex) {
      ...
      case 11: break; // Limites Saque — sem refresh do AdminService
      case 12: break; // Reset
