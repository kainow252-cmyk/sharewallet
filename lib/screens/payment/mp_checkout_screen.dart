    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Clique em "Pagar com Mercado Pago" para finalizar a assinatura.',
          ...
          Row(
            children: [
              ...
              Padding(
                ...
                child: Text('ou teste no sandbox',
                    style: TextStyle(
          ...
          // ── Botão sandbox: Simular pagamento ─────────────────────────────
          SizedBox(
            width: double.infinity,
            height: 50,
              ...
              child: isLoading
                  ...
                  : const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text('Simular Pagamento Aprovado (Sandbox)',
